...
const CartProps = (props) => {
  const { image, features, id, name, published_in } = props.data;
  return (
    <div className="card bg-base-100 shadow-xl text-black">
      ...
      <div className="card-body">
        ...
        <div className="flex items-center">
          ...
          <div>
            <p className="pl-2">{published_in}</p>
          </div>
          <div className="ml-auto cursor-pointer hover:bg-red-300 rounded-full p-2">
            <svg
            Shoes
            Features
              xmlns="http://www.w3.org/2000/svg"
